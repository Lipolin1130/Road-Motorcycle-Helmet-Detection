...
if __name__ == "__main__":
    json_folder_path = 'D:\\Project\\Road Motorcycle Helmet Detection\\Annotations' #存放json的文件夹的绝对路径
    txt_outer_path='D:\\Project\\Road Motorcycle Helmet Detection\\YOLOLables\\' #存放txt的文件夹绝对路径
